...
class _LogBookState extends State<LogBook> {
  @override
  void initState() {
    context.read<NetworkBloc>().add(GetReport());
    super.initState();
  }
        ...
        return Scaffold(
          body: Column(
            children: [
              Container(
                ...
                decoration: const BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage("assets/images/log_frame.png"),
                        fit: BoxFit.fill)),
              ...
              Expanded(
                  child: state is ReportsFetched
                    ? ListView.builder(
                  padding: const EdgeInsets.only(bottom: 20),
                  itemCount: state.reports.length,
                  itemBuilder: (_, idx){
                    return LogBookItem(data: state.reports[idx]);
                  },
                ): const SizedBox()
              ),
            ],
